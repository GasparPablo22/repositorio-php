...
botones.forEach(boton =>{
    ...
    boton.addEventListener("click", function(){
        ...
        if(confirm){
            //solicitud AJAX
            httpRequest("http://localhost/Modelos/consulta/eliminarAlumno/" + matricula, function(){
...
function httpRequest(url, callback){
    ...
    http.onreadystatechange = function(){
        if(this.readyState == 4 && this.status == 200){//la solicitud se concreto correctamente
